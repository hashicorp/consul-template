...
func TestTemplateConfig_Merge(t *testing.T) {
	...
	cases := []struct {
		...
		{
			"rotating_backups_overrides",
			&TemplateConfig{RotatingBackups: Int(1)},
			&TemplateConfig{RotatingBackups: Int(2)},
			&TemplateConfig{RotatingBackups: Int(2)},
		},
		{
			"rotating_backups_empty_one",
			&TemplateConfig{RotatingBackups: Int(1)},
			&TemplateConfig{},
			&TemplateConfig{RotatingBackups: Int(1)},
		},
		{
			"rotating_backups_empty_two",
			&TemplateConfig{},
			&TemplateConfig{RotatingBackups: Int(1)},
			&TemplateConfig{RotatingBackups: Int(1)},
		},
		{
			"rotating_backups_same",
			&TemplateConfig{RotatingBackups: Int(1)},
			&TemplateConfig{RotatingBackups: Int(1)},
			&TemplateConfig{RotatingBackups: Int(1)},
		},
