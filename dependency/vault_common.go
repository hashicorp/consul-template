...
var (
	// ErrVaultTTLZero is returned when a rotating secret has TTL=0
	ErrVaultTTLZero = errors.New("vault rotating secret returned ttl=0, will retry")
)
