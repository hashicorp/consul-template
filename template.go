...
func funcMap(brain *Brain, used, missing map[string]dep.Dependency) template.FuncMap {
	return template.FuncMap{
		...
		"lookupIP":    lookupIPFunc(brain, used, missing, dep.ParseLookupIP),
		"lookupIPv4":  lookupIPFunc(brain, used, missing, dep.ParseLookupIPv4),
		"lookupIPv6":  lookupIPFunc(brain, used, missing, dep.ParseLookupIPv6),
