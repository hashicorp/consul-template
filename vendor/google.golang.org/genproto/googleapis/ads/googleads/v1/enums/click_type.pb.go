...
func (ClickTypeEnum_ClickType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_e96f35ef78cd8577, []int{0, 0}
}
...
func (*ClickTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_e96f35ef78cd8577, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/enums/click_type.proto", fileDescriptor_e96f35ef78cd8577)
}

var fileDescriptor_e96f35ef78cd8577 = []byte{
